...
icon_output=$(build_icon_section "$sep_icon_start" "$sep_icon_end" "$WHITE_COLOR" "$final_accent_color_icon" "$PLUGIN_ICON")
content_output=$(build_content_section "$WHITE_COLOR" "$final_accent_color" "$content")
